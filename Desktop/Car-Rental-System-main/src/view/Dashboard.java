...
//         JLabel subTitle = new JLabel("Car Rental Management");

//         subTitle.setForeground(new Color(180, 180, 180));

//         subTitle.setFont(new Font("Segoe UI", Font.PLAIN, 15));

//         subTitle.setBounds(30, 120, 220, 30);
...
//         logoutButton = createMenuButton("Logout", 700);
...
//         topPanel.setBounds(250, 0, 1400, 100);
...
//         searchField.setBounds(760, 28, 420, 42);
...
//         scrollPane.setBounds(250, 100, 1295, 760);
...
//         scrollPane.getViewport().setBackground(new Color(8, 12, 24));
